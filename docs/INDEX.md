...
- [releases/2026-07-15-current-studio-release.md](releases/2026-07-15-current-studio-release.md) - 当前 Studio 发布范围、数据边界、验证结果和升级说明。
...
- [34-fmm-mainroad-weighted-mechanism.md](34-fmm-mainroad-weighted-mechanism.md) - `mainroad` FMM 的主路偏好、原始几何防绕路、速度 * 稀疏度道路等级先验、版本隔离和 Studio 批次元信息接入机制。
...
- [../adapters/signal_gps_compare/README.md](../adapters/signal_gps_compare/README.md) - 多天信令按 GPS 分段切片，并将信令还原结果对齐 GPS 真值分段生成 `gps_comparison` 正确率展示。
- [../adapters/transfer_recovery_signal_truth_layers/README.md](../adapters/transfer_recovery_signal_truth_layers/README.md) - Dalian 与 Chania 跨城市信令、GPS 和 GPS truth 的只读多图层 batch adapter。
